    ...
    <section className="h-screen bg-[url('./assets/images/background.jpg')] bg-no-repeat bg-cover">
      ...
      <div className="flex flex-row justify-center items-center lg:p-8 mb-10">
        <div className="bg-[#FCF4E9] h-64 lg:h-48 border rounded-xl overflow-hidden mt-8 w-48 lg:w-64 p-2 lg:p-6 relative  hover:bg-[#e6d5d5]  hover:duration-500 hover:ease-in-out">
          <div className="object-cover text-center bg-[#CD5555] border-black border-2 rounded-full w-8 h-8 overflow-hidden mx-auto font-bold text-lg mb-2 hover:rotate-45 hover:duration-300 hover:ease-in-out">
            1
          </div>
      ...
      <div className="z-[1] text-center relative">
        <Link
          to="/shopping"
          className="mx-auto my-8 bg-[#FCF4E9] text-[#CD5555] py-2 px-4 rounded-full font-bold text-lg inline-block "
        >
          <span className="inline-block">
            <GiFruitBowl className="inline-block mr-2 text-xl hover:rotate-45 hover:duration-300 hover:ease-in-out " />
            Voir les produits
          </span>
        </Link>
      </div>
