      ...
      <div className="px-6 sm:px-8 lg:px-16 sm:block">
        <div className="flex items-center justify-between h-16 -mb-px">
          ...
          <div className="flex items-center sm:space-x-5">
            <Link
              to="/shopping"
              className="flex text-center items-center sm:px-1 px-4 py-2 text-sm font-medium tracking-wide text-[#CD5555] m-1 hover:text-[#a43e3e] transition ease-in-out"
            >
              {" "}
              <GiFruitBowl
                className="mr-2 hover:rotate-45 hover:duration-300 hover:ease-in-out"
